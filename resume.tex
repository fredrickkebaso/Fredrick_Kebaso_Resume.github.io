...
\newcommand{\elia}[1]{{\leavevmode{\textcolor{orange}{\textbf{[Elia: #1]}}}}}
...
\name{Fredrick Kebaso}{Mariita}

\mobile{(+254) 701718080}
\email{fredrickkebaso@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/fredrickkebaso}
\linkedin{linkedin.com/in/fredrickkebaso-bioinformatician}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
\twitter{@fredrickkebaso}
% \skype{skype-id}
% \reddit{reddit-id}
% \medium{madium-id}
% \kaggle{kaggle-id}
